...
- Added a high-level `research` tool backed by a backend `ResearchAgent` service, with quick factual research, structured findings, sources, searches, unresolved items, and run-context trace capture.
